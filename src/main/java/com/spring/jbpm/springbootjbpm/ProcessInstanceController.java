...
public class ProcessInstanceController {
    ...
    public Collection<ProcessInstanceDesc> getProcessInstances() {
        Collection<ProcessInstanceDesc> processInstances =
                runtimeDataService.getProcessInstances(new QueryContext(0, 100, "status", true));
    ...
    public String abortProcessInstance(@RequestParam String id) {
        ...
        return String.format("Process instance %s aborted successfully", id);
    }
    ...
    public String signalProcessInstance(@RequestParam String id, @RequestParam String signal, @RequestParam String data) {
        ...
        return String.format("Signal sent to process instance %s successfully", id);
    }
}
